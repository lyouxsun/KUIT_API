...
public class UserDao {
    ...
    public long createUser(PostUserRequest postUserRequest) {
        String sql = "insert into user(email, password, phone_number, nickname, profile_picture) " +
    ...
    public long modifyUserStatus_dormant(long userId) {
    ...
    public long modifyUserStatus_deleted(long userId) {
        String sql = "update user set status=:status where user_id=:user_id";
        Map<String, Object> param = Map.of(
                "status", "deleted",
                "user_id", userId);
    ...
    public long modifyNickname(long userId, String nickname) {
    ...
    public List<GetUserResponse> getUsers(String nickname, String email, String status) {
        String sql = "select email, phone_number, nickname, profile_picture, status from user" +
    ...
    public long modifyPassword(long userId, String password) {
